...
if __name__ == "__main__":
    ...
    clustering_model = deep_clustering.ClusteringModel(dataset_loader, logger=logger, pre_train_epochs=100)
    # clustering_model.train(clustering_epochs=500, update_freq=1)