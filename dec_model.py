...
if __name__ == "__main__":
    ...
    if args.uuid:
        ...
        pca_components = 50
        latent_dims = 5
        pca_model = pca.PCAModel(logger=logger, uuid_path=os.path.join(config.OUTPUT_PATH, args.uuid), n_components=pca_components)
        data = []
        labels = []
        ...
        ae = autoencoder.AutoEncoder(hidden_layers=hidden_layers, logger=logger, loader=reduced_loader, epochs=10000, dropout_rate=0.1, figures_path=loader.get_figures_path())
        ae.train()
